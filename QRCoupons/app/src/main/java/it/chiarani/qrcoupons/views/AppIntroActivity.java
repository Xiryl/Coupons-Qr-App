...
public class AppIntroActivity extends AppIntro2 {
  ...
  /*  addSlide(first_fragment);
    ...
    addSlide(AppIntroFragment.newInstance("Approvazione dei Permessi", "I permessi di scrittura mi serviranno per poter salvare in loco in modo permanente i tuoi codici QR scansionati!", R.drawable.ic_storage, Color.parseColor("#51B9D1")));
